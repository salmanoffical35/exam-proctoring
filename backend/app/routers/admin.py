...
from app.utils.jwt_handler import require_admin, get_current_user
...
def all_sessions(
    ...
    """All exam sessions, optionally filtered by exam."""
...
def session_detail(
    ...
    """Full detail of one session including all alerts."""
